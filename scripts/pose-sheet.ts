/** Screenshot the pose contact sheet to docs/poses.png (needs `npx vite preview` or a dev server on :4173). */
import { chromium } from '@playwright/test';
const url = process.env.POSE_URL ?? 'http://localhost:4173/boundless-neon/#/dev/poses';
