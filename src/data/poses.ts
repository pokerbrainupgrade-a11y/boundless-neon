...
export const poses: Record<string, Pose> = {
  ...
  swim: { id: 'swim', label: 'Person swimming freestyle, one arm reaching forward and one recovering', figure: f({ hip: [56, 62], torso: 175, head: 230, uArmL: 185, lArmL: 185, uArmR: 0, lArmR: -30, thighL: 5, shinL: 20, thighR: -10, shinR: 5 }), props: [{ type: 'water', y: 62 }], noBelly: true },
  ...
  anchoredBackExtension: { id: 'anchoredBackExtension', label: 'Anchored back extension: face down, chest lifted, elbows bent with hands by the shoulders, feet slightly up', figure: f({ hip: [50, 85], torso: 190, head: 200, uArmL: 25, lArmL: -110, uArmR: 20, lArmR: -110, thighL: 0, shinL: -8, thighR: 0, shinR: -12 }), props: FLOOR, noBelly: true },
  ...
  proneDecompression: { id: 'proneDecompression', label: 'Prone decompression: face down with arms forward on the floor and the head lifted slightly', figure: f({ hip: [58, 85], torso: 180, head: 220, uArmL: 178, lArmL: 178, uArmR: 176, lArmR: 178, thighL: 0, shinL: 0, thighR: 0, shinR: 0 }), props: FLOOR, noBelly: true },
  ...
  pushup: { id: 'pushup', label: 'Push-up at the bottom: body in one line, elbows bent, chest near the floor', figure: f({ hip: [56, 80], torso: 195, uArmL: 45, lArmL: 140, uArmR: 40, lArmR: 145, thighL: 10, shinL: 15, thighR: 8, shinR: 18 }), props: FLOOR, noBelly: true },
  ...
  plank: { id: 'plank', label: 'Forearm plank: straight line from head to heels', figure: f({ hip: [56, 82], torso: 190, uArmL: 105, lArmL: 180, uArmR: 110, lArmR: 180, thighL: 9, shinL: 13, thighR: 10, shinR: 14 }), props: FLOOR, noBelly: true },
  ...
  pushupRotation: { id: 'pushupRotation', label: 'Push-up with rotation: side plank on one straight arm, the other arm reaching up', figure: f({ hip: [50, 73], torso: 200, uArmL: 95, lArmL: 92, uArmR: -85, lArmR: -80, thighL: 22, shinL: 36, thighR: 20, shinR: 38 }), props: FLOOR, noBelly: true },
  sidePlank: { id: 'sidePlank', label: 'Side plank on one forearm: body in one line, hips up, top arm raised', figure: f({ hip: [54, 84], torso: 200, uArmL: 110, lArmL: 180, uArmR: -80, lArmR: -85, thighL: 8, shinL: 12, thighR: 6, shinR: 14 }), props: FLOOR, noBelly: true },
  burpee: { id: 'burpee', label: 'Burpee at the bottom: plank on straight arms', figure: f({ hip: [56, 71], torso: 200, uArmL: 94, lArmL: 86, uArmR: 92, lArmR: 88, thighL: 22, shinL: 45, thighR: 20, shinR: 47 }), props: FLOOR, noBelly: true },
  clappingPushup: { id: 'clappingPushup', label: 'Clapping push-up: body in a plank line with hands off the floor, clapping under the chest', figure: f({ hip: [56, 71], torso: 200, uArmL: 75, lArmL: 45, uArmR: 65, lArmR: 55, thighL: 22, shinL: 45, thighR: 20, shinR: 47 }), props: FLOOR, noBelly: true },
  ...
  // ---- prenatal replacements ----
  stepJack: { id: 'stepJack', label: 'Step jack: one leg stepped out to the side, arms raised overhead', figure: f({ ...ARMS_UP, thighL: 92, shinL: 90, thighR: 65, shinR: 80 }), props: FLOOR },
  standingKneeDrive: { id: 'standingKneeDrive', label: 'Standing knee drive: one knee lifted to hip height, hand resting on a wall for balance', figure: f({ uArmL: 100, lArmL: 95, uArmR: 20, lArmR: 10, thighL: 92, shinL: 90, thighR: -5, shinR: 95 }), props: [{ type: 'wall', x: 76 }, { type: 'floor' }] },
  inclinePushup: { id: 'inclinePushup', label: 'Incline push-up: hands on a bench, elbows bent, body in one angled line', figure: f({ hip: [50.7, 68.8], torso: -140, uArmL: 158, lArmL: 32, uArmR: 160, lArmR: 30, thighL: 40, shinL: 40, thighR: 38, shinR: 42 }), props: [{ type: 'bench', x: 10, y: 65, w: 26 }, { type: 'floor' }], noBelly: true },
  wallPushup: { id: 'wallPushup', label: 'Wall push-up: hands on the wall at chest height, body angled in one line', figure: f({ hip: [46, 58], torso: -70, uArmL: 42, lArmL: -25, uArmR: 40, lArmR: -25, thighL: 105, shinL: 105, thighR: 103, shinR: 107 }), props: [{ type: 'wall', x: 76 }, { type: 'floor' }] },
  inclinePlank: { id: 'inclinePlank', label: 'Incline plank: straight arms on a bench, body in one angled line', figure: f({ hip: [52.8, 64.7], torso: -130, uArmL: 102, lArmL: 95, uArmR: 100, lArmR: 95, thighL: 50, shinL: 50, thighR: 48, shinR: 52 }), props: [{ type: 'bench', x: 12, y: 73, w: 26 }, { type: 'floor' }], noBelly: true },
  kneelingSidePlank: { id: 'kneelingSidePlank', label: 'Kneeling side plank: bottom knee on the floor, forearm down, hips lifted, top arm raised', figure: f({ hip: [54, 81], torso: 190, uArmL: 100, lArmL: 180, uArmR: -85, lArmR: -80, thighL: 30, shinL: 0, thighR: 12, shinR: 12 }), props: FLOOR, noBelly: true },
  squatToStand: { id: 'squatToStand', label: 'Squat-to-stand: deep squat with hands on the floor between the feet', figure: f({ hip: [38, 74], torso: -30, uArmL: 95, lArmL: 90, uArmR: 85, lArmR: 90, thighL: 8, shinL: 85, thighR: 2, shinR: 88 }), props: FLOOR },
  sideLyingLegTracing: { id: 'sideLyingLegTracing', label: 'Side-lying leg tracing: on one side with the head propped on a hand, top knee bent and sliding along the bottom leg', figure: f({ hip: [52, 85], torso: 180, head: 215, uArmL: 170, lArmL: -100, uArmR: 10, lArmR: -20, thighL: 0, shinL: 0, thighR: -60, shinR: 60 }), props: FLOOR, noBelly: true },
  proppedBridge: { id: 'proppedBridge', label: 'Propped bridge: reclined on a pillow at 30 degrees, knees bent, hips lifted slightly', figure: f({ hip: [50, 80], torso: 210, uArmL: 60, lArmL: 20, uArmR: 65, lArmR: 15, thighL: -30, shinL: 88, thighR: -25, shinR: 90 }), props: [{ type: 'pillow', x: 34, y: 79, angle: 30 }, { type: 'floor' }] },
  proppedDecompression: { id: 'proppedDecompression', label: 'Propped decompression: reclined on pillows at 30 degrees, legs long, relaxed', figure: f({ hip: [48, 84], torso: 210, uArmL: 50, lArmL: 10, uArmR: 55, lArmR: 8, thighL: -8, shinL: 10, thighR: -12, shinR: 14 }), props: [{ type: 'pillow', x: 36, y: 82, angle: 30 }, { type: 'pillow', x: 27, y: 77, angle: 30 }, { type: 'floor' }] },
  quadrupedLengthening: { id: 'quadrupedLengthening', label: 'Quadruped lengthening: on hands and knees with a long spine and neutral head', figure: f({ hip: [60, 73], torso: 200, uArmL: 100, lArmL: 85, uArmR: 95, lArmR: 88, thighL: 88, shinL: 2, thighR: 90, shinR: 0, facing: 'left' }), props: FLOOR },
  wallDecompression: { id: 'wallDecompression', label: 'Wall decompression: standing with the back to a wall, arms open, chest lifted', figure: f({ ...ARMS_OPEN, hip: [45, 57], thighL: 93, shinL: 90, thighR: 87, shinR: 90 }), props: [{ type: 'wall', x: 40 }, { type: 'floor' }] },
  ...
  mountainClimber: { id: 'mountainClimber', label: 'Mountain climber: plank on straight arms with one knee driven under the chest', figure: f({ hip: [56, 71], torso: 200, uArmL: 94, lArmL: 86, uArmR: 92, lArmR: 88, thighL: 22, shinL: 45, thighR: 160, shinR: 50 }), props: FLOOR, noBelly: true },
  ...
  rollHip: { id: 'rollHip', label: 'Rolling the outer hip: side-lying on a forearm with the roller under the hip, top foot on the floor', figure: f({ hip: [50, 82], torso: 195, uArmL: 100, lArmL: 180, uArmR: 60, lArmR: 10, thighL: 5, shinL: 5, thighR: -30, shinR: 80 }), props: [{ type: 'roller', x: 50, y: 86.5 }, { type: 'floor' }], noBelly: true },
  rollITBand: { id: 'rollITBand', label: 'Rolling the IT band: side-lying on a forearm with the roller under the outer thigh, top foot crossed in front', figure: f({ hip: [48, 82], torso: 195, uArmL: 100, lArmL: 180, uArmR: 60, lArmR: 10, thighL: 5, shinL: 5, thighR: -25, shinR: 80 }), props: [{ type: 'roller', x: 60, y: 86.5 }, { type: 'floor' }], noBelly: true },
  rollAdductor: { id: 'rollAdductor', label: 'Rolling the adductor: face down on the forearms with one leg bent out to the side over the roller', figure: f({ hip: [50, 84], torso: 195, head: 200, uArmL: 105, lArmL: 180, uArmR: 100, lArmR: 180, thighL: 5, shinL: 3, thighR: -55, shinR: 60 }), props: [{ type: 'roller', x: 57, y: 86.5 }, { type: 'floor' }], noBelly: true },
  ...
  rollShoulder: { id: 'rollShoulder', label: 'Rolling the shoulder: side-lying with the roller under the armpit and the bottom arm extended overhead', figure: f({ hip: [56, 84], torso: 185, head: 220, uArmL: 178, lArmL: 178, uArmR: 40, lArmR: 0, thighL: 3, shinL: 3, thighR: -20, shinR: 45 }), props: [{ type: 'roller', x: 34, y: 87.5 }, { type: 'floor' }], noBelly: true },
  ...
  rollQuad: { id: 'rollQuad', label: 'Rolling the quads: face down on the forearms with the roller under the thighs', figure: f({ hip: [52, 80], torso: 195, head: 200, uArmL: 112, lArmL: 180, uArmR: 108, lArmR: 180, thighL: 5, shinL: 15, thighR: 3, shinR: 17 }), props: [{ type: 'roller', x: 61, y: 86.5 }, { type: 'floor' }], noBelly: true },
};
