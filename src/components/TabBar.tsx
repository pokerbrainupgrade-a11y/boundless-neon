...
const tabs: { id: string; label: string; icon: string }[] = [
  ...
  { id: 'moves', label: 'MOVES', icon: 'M12 3a2 2 0 1 0 0 4 2 2 0 0 0 0-4z M12 7v6 M12 13l-4 6 M12 13l4 6 M6 10l6-1 6 1' },
  { id: 'journal', label: 'JOURNAL', icon: 'M6 3h12v18H6z M9 8h6 M9 12h6 M9 16h4' },
  { id: 'progress', label: 'PROGRESS', icon: 'M4 20h16 M6 16l4-5 4 3 5-7' },
];
